...
{
    // Created this base class from the original ContentController<T> class in the N2 Framework.
    // Made my own version so that it's built against the System.Web.Mvc 3.0 instead of the 2.0
    // that the N2 Framework lib is built against.
    // BJF February 29, 2012.
    ...
    public abstract class ContentControllerBase<T> : Controller where T : ContentItem
    {
        #region Accessors
