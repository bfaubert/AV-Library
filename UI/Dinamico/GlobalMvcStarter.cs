...
namespace Dinamico
{
    ...
    public class GlobalMvcStarter : IPluginInitializer
    {
        ...
        public static void RegisterDependencies(IEngine engine)
        {
            //engine.Container.AddComponent("ITestIoc", typeof(ITestIoc), typeof(Test2IocImp));
            ((WindsorServiceContainer)engine.Container).Container.AddFacility<PersistenceFacility>();
        }
    }
}
